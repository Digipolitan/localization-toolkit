# Contributing to localization-toolkit
...
* **Did the problem start happening recently** (e.g. after updating to a new version of localization-toolkit) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of localization-toolkit ?** What's the most recent version in which the problem doesn't happen? You can download older versions of localization-toolkit from [the releases page](https://github.com/digipolitan/localization-toolkit/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of localization-toolkit are you using?
...
#### Template For Submitting Bug Reports
    ...
    **localization-toolkit version:** [Enter localization-toolkit version here]
    ...
    * Problem started happening recently, didn't happen in an older version of localization-toolkit: [Yes/No]
